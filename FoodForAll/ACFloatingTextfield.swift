...
@objc open class ACFloatingTextfield: UITextField {
     ...
     @IBInspectable open var lineColor : UIColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
...
fileprivate extension ACFloatingTextfield {
    ...
    func addBottomLine(){
        ...
        {
            bottomLineView?.backgroundColor = #colorLiteral(red: 0.6783729196, green: 0.6784700155, blue: 0.678342402, alpha: 1);
        }
