...
fileprivate extension ACFloatingTextfield {
    ...
    func addBottomLine(){
        ...
        bottomLineView = UIView(frame: CGRect(x:0, y:self.frame.height-1, width:self.frame.width+25, height:1))
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder = UILabel(frame: CGRect(x:0, y:0, width:self.frame.size.width-5, height:self.frame.height))
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder = UILabel(frame: CGRect(x:0, y:0, width:self.frame.size.width-5, height:self.frame.height))
    ...
    func resignPlaceholder() -> Void {
        ...
        let labelFrame = CGRect(x:0, y:0, width:self.frame.size.width-5, height:self.frame.size.height)
