...
//    
//    class func requestPostWithMultiFormData(_ strURL : String, params : [String : String]?, headers : [String : String]?, success:@escaping (NSDictionary) -> Void, failure:@escaping (NSError) -> Void){
//    
...
// MARK: Alamofire Multiform data post api :
    ...
    {
        let alert = UIAlertController(title:Constants.applicationName, message: "SHARE", preferredStyle: UIAlertControllerStyle.alert)
  ...
  class  func animateCellAtIndexPath(indexPath: NSIndexPath, tableViewView:UITableView)
    ...
    class func badgeCount(button:UIButton) -> Void
    {
//        let badgeValue:String = szBadgeCount()
//        button.badgeValue = String(format:"%@",badgeValue)
//        button.badgeBGColor = UIColor.white
//        button.badgeTextColor = colorWithHexString("508215")
    }
